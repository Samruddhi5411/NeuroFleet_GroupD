          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-dark-700 text-white rounded-lg border ${errors.vehicleNumber ? 'border-red-500' : 'border-white/10'
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 bg-dark-700 text-white rounded-lg border ${errors.model ? 'border-red-500' : 'border-white/10'
                  } focus:border-accent-cyan focus:outline-none transition-colors`}
                placeholder="Model S"
              />
              {errors.model && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 bg-dark-700 text-white rounded-lg border ${errors.manufacturer ? 'border-red-500' : 'border-white/10'
                  } focus:border-accent-cyan focus:outline-none transition-colors`}
                placeholder="Tesla"
              />
              {errors.manufacturer && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 bg-dark-700 text-white rounded-lg border ${errors.capacity ? 'border-red-500' : 'border-white/10'
                  } focus:border-accent-cyan focus:outline-none transition-colors`}
                min="1"
              />
              {errors.capacity && (
            ...
            {formData.isElectric ? (
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-dark-700 text-white rounded-lg border ${errors.batteryLevel ? 'border-red-500' : 'border-white/10'
                    } focus:border-accent-cyan focus:outline-none transition-colors`}
                  min="0"
                  max="100"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-dark-700 text-white rounded-lg border ${errors.fuelLevel ? 'border-red-500' : 'border-white/10'
                    } focus:border-accent-cyan focus:outline-none transition-colors`}
                  min="0"
                  max="100"
                />
